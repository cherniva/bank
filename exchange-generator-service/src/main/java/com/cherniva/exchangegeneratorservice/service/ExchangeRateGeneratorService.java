...
public class ExchangeRateGeneratorService {
    ...
    public void generateAndSendExchangeRates() {
        try {
            ...
            // Send to exchange service
            String exchangeServiceUrl = "http://exchange-service/exchange/course/update";
            restTemplate.postForObject(exchangeServiceUrl, rates, Object.class);
